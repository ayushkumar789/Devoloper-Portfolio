										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">Aug 2007 – May 2020:</p>
													<div>
														<span className="text-primary-2">Nava Bharat Public School</span>
														<p className="text-dark">High School / Secondary Education (C.B.S.E Affiliated) - Palwancha, Telangana</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">Aug 2020 – May 2022:</p>
													<div>
														<span className="text-primary-2">Sri Chaitanya Junior College</span>
														<p className="text-dark">Intermediate in MPC (Mathematics, Physics, Chemistry) - Hyderabad, Telangana</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">Aug 2022 – May 2026:</p>
													<div>
														<span className="text-primary-2">Anurag University</span>
														<p className="text-dark">B.Tech in Computer Science & Engineering (Data Science Specialization) - Hyderabad, Telangana</p>
													</div>
												</div>
											</li>
										</ul>
									...
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">AWS Certified Cloud Practitioner</span>
													<p className="text-dark">Fundamentals of AWS Cloud Computing.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Google Data Analytics</span>
													<p className="text-dark">Hands-on experience in data analysis using Python and SQL.</p>
												</div>
											</div>
										</li>
									</ul>
